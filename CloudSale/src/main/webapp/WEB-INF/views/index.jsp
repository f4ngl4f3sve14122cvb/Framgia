...
<link href="${pageContext.request.contextPath}/resources/css/bootstrap.min.css"
	rel="stylesheet">
<link href="${pageContext.request.contextPath}/resources/css/templatemo-style.css"
	rel="stylesheet">
	...
	<div class="templatemo-flex-row">
		<div class="templatemo-sidebar">
			...
			<div class="profile-photo-container">
				<img src="${pageContext.request.contextPath}/resources/img/profile-photo.jpg" alt="Profile Photo"
			...
			<ul>
				<li><a href="${pageContext.request.contextPath}/user" class="active"><i class="fa fa-home fa-fw"></i>USers Manager</a></li>
				...
				<li><a href="${pageContext.request.contextPath}/shop"><i class="fa fa-map-marker fa-fw"></i>Shop Manager</a></li>
				<li><a href="manage-users.html"><i
						class="fa fa-users fa-fw"></i>Order Manager</a></li>
				<li><a href="${pageContext.request.contextPath}/logout"><i class="fa fa-eject fa-fw"></i>Sign
						Out</a></li>
			</ul>
			</nav>
		</div>
