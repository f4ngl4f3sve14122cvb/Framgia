...
public class CustomerHome {
	...
	public Customer findById(java.lang.Integer id) {
		...
		try {
			Customer instance = (Customer) sessionFactory.getCurrentSession().get("com.framgia.model.Customer", id);
			if (instance == null) {
	...
	public List<Customer> findByExample(Customer instance) {
		...
		try {
			List<Customer> results = (List<Customer>) sessionFactory.getCurrentSession()
					.createCriteria("com.framgia.model.Customer").add(create(instance)).list();
