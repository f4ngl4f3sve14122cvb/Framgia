...
public class ShopHome {
	...
	public Shop merge(Shop detachedInstance) {
		...
		try {
			Shop result = (Shop) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Shop findById(int id) {
		...
		try {
			Shop instance = (Shop) sessionFactory.getCurrentSession().get("com.framgia.model.Shop", id);
			if (instance == null) {
	...
	public List<Shop> findByExample(Shop instance) {
		...
		try {
			List<Shop> results = (List<Shop>) sessionFactory.getCurrentSession()
					.createCriteria("com.framgia.model.Shop").add(create(instance)).list();
