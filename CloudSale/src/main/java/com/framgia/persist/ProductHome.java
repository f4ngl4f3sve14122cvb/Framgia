...
public class ProductHome {
	...
	public Product findById(int id) {
		...
		try {
			Product instance = (Product) sessionFactory.getCurrentSession().get("com.framgia.model.Product", id);
			if (instance == null) {
	...
	public List<Product> findByExample(Product instance) {
		...
		try {
			List<Product> results = (List<Product>) sessionFactory.getCurrentSession()
					.createCriteria("com.framgia.model.Product").add(create(instance)).list();
